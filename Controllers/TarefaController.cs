...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        {
            // Buscar as tarefas que têm a mesma data
            var tarefas = _context.Tarefas
        ...
        {
            // Buscar as tarefas que têm o status recebido por parâmetro
            var tarefas = _context.Tarefas
        ...
        public IActionResult Criar(Tarefa tarefa)
        {
            ...
            // Retornar CreatedAtAction para indicar que o recurso foi criado com sucesso
